            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="info">
                        ...
                        <br>
                        <p class="address"><i class="lni-map-marker"></i>{{$sproperty->area1.', '.$sproperty->district.',  '.$sproperty->city .',  '.$sproperty->province}} ,Afghanistan</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="details">
                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="others">
                        <ul>
                            <li><span>{{trans('localization.price')}}: {{'$'.$sproperty->price}}</span></li>
            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <div class="property-slider">
                    <div id="property-slider" class="owl-carousel owl-theme">
                        @foreach(json_decode($sproperty->banner, true) as $images)
                    ...
                    <div class="agent-inner">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody><tr>
                                ...
                                <td>
                                    <small><strong>{{ucfirst($sproperty->user->name)}}</strong></small>
                                </td>
                            </tr>
                            <!-- </thead> -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <small>For {{$sproperty->status}}</small>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <small>{{$sproperty->area}} {{$sproperty->sizetypr}}</small>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <small>{{ucfirst($sproperty->user->number)}}</small>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <small>{{ucfirst($sproperty->user->email)}}</small>
                                </td>
                            </tr>
...
@include('scripts')
<script>
    var  lat = parseFloat('{{$sproperty->lat}}');
    var  lng = parseFloat('{{$sproperty->lng}}');
