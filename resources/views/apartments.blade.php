...
<div id="page-banner-area" class="page-banner">
    <div class="page-banner-title">
        <div class="text-center">
            <h2>{{trans('localization.menue-apartments')}}</h2>
            <a href="#"><i class="lni-home"></i>{{trans('localization.home')}}</a>
            <span class="crumbs-spacer"><i class="lni-chevron-right"></i></span>
            <span class="current">{{trans('localization.menue-apartments')}}</span>
        </div>
    </div>
</div>
                        ...
                        <div class="property-wrap">
                            <div class="property-item">
                                <div class="item-thumb">
                                    ...
                                    <a class="hover-effect" href="{{route('bapartment',$bhouse->id)}}">
                                ...
                                <div class="item-body">
                                    <h3 class="property-title"><a href="{{route('bapartment',$bhouse->id)}}">{{$bhouse->title}}</a></h3>
                                    <div class="adderess"><i class="lni-map-marker"></i>{{$bhouse->city.',  '.$bhouse->province .'  '}} ,Afghanistan</div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="property-main">
                        <div class="property-wrap">
                            <div class="property-item">
                                <div class="item-thumb">
                                    <a class="hover-effect" href="{{route('apartment',$house->id)}}">
                                ...
                                <div class="item-body">
                                    <h3 class="property-title"><a href="{{route('apartment',$house->id)}}">{{$house->title}}</a></h3>
