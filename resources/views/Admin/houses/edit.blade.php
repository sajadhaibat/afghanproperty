...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
               Edit_Houses
                <small>Edit  Houses form here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form role="form"  action="{{route('property.update',$edit->id)}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="location"  placeholder="location" required value="{{$edit->city}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="status"  placeholder="status" required value="{{$edit->status}}">
                        </div>
    ...
    <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="banner[]"  placeholder="photo"  multiple  value="@foreach(json_decode($edit->banner, true) as $images) {{$images}} @endforeach" >
                        </div>
