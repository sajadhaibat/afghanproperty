...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
               Edit_Apartments
                <small>Edit  Apartments from here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form role="form"  action="{{route('updateapartment',$edit->id)}}" method="post" enctype="multipart/form-data">
