...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Shops
                <small>Manage all the Shops from here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <a class="btn btn-info " href="#">Shops</a>
                    <br><br>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($shops as $shop)
                            <tr style="border-bottom: 4px solid #ffffff;">
                                ...
                                <td><img src="{{asset('images')}}\{{json_decode($shop->banner, true)[0]}}" alt="nothing" height="70px" width="100px" ></td>

                                <td ><a href="{{route('shops.edit',$shop->id)}}" class="btn btn-success"><i class="fa fa-edit"></i></a></td>
                                <td ><form action="{{route('property.delete',$shop->id)}} " method="get" >
