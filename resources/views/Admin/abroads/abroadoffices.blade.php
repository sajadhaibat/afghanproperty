...
<head>
    ...
    <title>Admin | Abroad Offices</title>
...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Abroad Offices
                <small>Manage all the Abroad offices from here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <a class="btn btn-warning" href="#">Abroad_Offices</a>
                    <br><br>
