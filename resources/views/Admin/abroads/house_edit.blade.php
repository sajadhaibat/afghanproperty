...
<head>
    ...
    <title>Edit |Abroad Houses</title>
...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Edit
                <small>Edit Abroad Properties form here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <form role="form"  action="{{route('broad.update',$edit->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="area1"  placeholder="area1" required value="{{$edit->area1}}">
                        </div>
