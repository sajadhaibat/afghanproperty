   ...
   @include('adminaside')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Lands
                <small>Manage all the lands from here</small>
            </h1>
        </section>
        <hr>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <a class="btn btn-danger" href="#">Lands</a>
                    <br><br>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr style="border-bottom:4px solid #ffffff;">
                            ...
                            <td>{{$land->price}}$</td>
                            <td>For {{$land->status}}</td>

                            <td>{{$land->user->name}}</td>
                            <td><img src="{{asset('/images')}}\{{json_decode($land->banner, true)[0]}}" alt="nothing" height="70px" width="100px" ></td>

                            <td ><a href="{{route('lands.edit',$land->id)}}" class="btn btn-success"><i class="fa fa-edit"></i></a></td>
                            <td ><form action="{{route('property.delete',$land->id)}} " method="get" >
