            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="info">
                        <h3>{{$boff->title}}</h3>
                        <br>
                        <p class="address"><i class="lni-map-marker"></i>{{$boff->district.',  '.$boff->city .'  '}} ,Afghanistan</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="details">
                        ...
                        <div class="property-wrap">
                            <div class="property-item">
                                ...
                                <div class="item-body">
                                    ...
                                    <div class="adderess"><i class="lni-map-marker"></i> {{$off->city.',  '.$off->province .'  '}} ,Afghanistan</div>
                                    <div class="pricin-list">
                                        <div class="property-price">
                                            <span>{{$off->price}}$</span>
                                        </div>
                                        <p><span>{{$off->area}} {{$off->sizetypr}}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
