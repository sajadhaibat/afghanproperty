                                ...
                                <div class="item-body">
                                    ...
                                    <div class="pricin-list">
                                       ...
                                       @if(trans('localization.lang')==='Dari' )
                                                    <p style="direction: rtl;font-size: 2px" ><span style="direction: rtl;font-size: 14px" >{{ trans('localization.room').' '.$off->bedrooms}} </span> , <span style="direction: rtl;font-size: 14px">. {{trans('localization.baths') . ' ' .$off->bathrooms}} </span> . <span style="direction: rtl;font-size: 14px">. {{ $off->sizetypr.' '.$off->area}}</span></p>
                                                @endif
